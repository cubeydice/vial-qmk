...
#define VIAL_ENCODER_DEFAULT {LCTL(KC_Z), LCTL(KC_Y),KC_VOLU, KC_VOLD,KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS,LCTL(KC_LBRACKET),LCTL(KC_RBRACKET),KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS}
